...
import_erddap <- function(start_date, stop_date, min_lat, max_lat, min_lon, max_lon) {
  ...
  file_name <- paste0("erddap_", start_date, "_", stop_date,
...
df_raw <- read_csv("data/2020-01-01_2021-06-01_lat_42.625_52.625_lon_229.875_236.625.csv")

auto_detect(df_raw, custom_date = "2020-11-01", threshold = 2)
```


https://coastwatch.pfeg.noaa.gov/erddap/tabledap/erdUI426hr.csv?time%2Cupwelling_index%2Cstation_id%2Clatitude%2Clongitude&time%3E=2021-05-24T00%3A00%3A00Z&time%3C=2021-05-31T18%3A00%3A00Z
