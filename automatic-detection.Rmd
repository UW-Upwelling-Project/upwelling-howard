...
## Past 20 Years: Proportion of Upwelling
...
## Line Plot of Proportion of Upwelling by Latitude Facetted by Year
...
final_df_year %>%
  ...
  geom_line(color = "midnightblue", show.legend = FALSE) +
...
Find latitude or longitude
```{r}
ui_search_df <- ui_search$info

ui_search_df %>% 
  filter(str_detect(title, "125W"))
```
